...
eval("/*import fon from '../../src/img/bg-grid.png'\r\n\r\ndocument.getElementById('wrapper').style.background=`url(${fon})`\r\ndocument.getElementById('wrapper').style.backgroundSize=`500px 500px`*/\n\n//# sourceURL=webpack:///./src/js/main.js?");
