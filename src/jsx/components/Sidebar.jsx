					...
					<div className='sidebar__item sidebar__info'>
						<ul className='sidebar__info-list'>
							<li className='sidebar__info-item'>
								<span className='sidebar__info-row sidebar__info-title'>
									Возраст:
								</span>
								<span className='sidebar__info-row sidebar__info-text'>
									31
								</span>
							</li>
							<li className='sidebar__info-item'>
					...
					<div className='sidebar-item sidebar__contacts'>
						<ul className='sidebar__contacts-list'>
							<li className='sidebar__contacts-item'>
								<a
									href='https://hh.ru/resume/d5cc3e7cff03ab38c60039ed1f416e4a6e6462'
									className='sidebar__contacts-link'
									target='_blank'
								>
									Резюме на hh
								</a>
							...
							<li className='sidebar__contacts-item'>
								<a
									href='https://www.codewars.com/users/Grimm'
									className='sidebar__contacts-link'
									target='_blank'
								>
									Codewars
